        ...
        <div className="mx-auto mt-16 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {posts.map((post) => (
            ...
            >
              ...
              <h4 className="text-2xl/6 font-semibold text-white">
                <a href={post.href}>
                  <span className="absolute inset-0" />
                  {post.amount_raised} raised
                </a>
              </h4>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-y-1 overflow-hidden text-sm/6 text-gray-300">
                ...
                <div className="-ml-4 flex items-center gap-x-4">
                  ...
                  <div className="flex gap-x-2.5">
                    <img alt="" src={post.charity.imageUrl} className="size-6 flex-none rounded-full bg-white/10" />
                    {post.charity.name}
                  </div>
                </div>
              </div>
