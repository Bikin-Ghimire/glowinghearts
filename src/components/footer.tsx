  ...
  return (
    <>
      <div>
        ...
        <SitemapLinks>
          <SitemapLink href="/#Features">About</SitemapLink>
      ...
      <div>
        ...
        <SitemapLinks>
          <SitemapLink href="/termsandconditions">Terms of service</SitemapLink>
              ...
              <div className="grid grid-cols-3 gap-y-10 pb-6 lg:grid-cols-5 lg:gap-8">
                <div className="col-span-2 flex">
                  <PlusGridItem className="pt-6 lg:pb-6">
                    <Image src={logo} alt="Glowing Hearts Fundraising" width={120} height={40}></Image>
                  </PlusGridItem>
                </div>
